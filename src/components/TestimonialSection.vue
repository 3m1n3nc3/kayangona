  ...
  <section id="testimonial" class="testimonial-area pt-120">
    <div class="container">
      ...
      <div
        ...
        data-wow-delay="0.8s"
      >
        <div class="w-full lg:w-1/3" :key="testimonial" v-for="testimonial in 3">
          <div class="single-testimonial">
            ...
            <div class="mb-8">
              <p>
                Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor
            ...
            <div class="flex items-center testimonial-author">
              <div class="relative author-image">
                <img class="shape" src="/src/assets/images/textimonial-shape.svg" alt="shape" />
                <img
                  class="author"
                  :src="`src/assets/images/author-${testimonial}.png`"
                  alt="author"
                />
              </div>
