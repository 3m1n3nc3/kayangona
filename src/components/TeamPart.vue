    ...
    <div class="container">
      ...
      <div class="justify-center row">
        <div class="w-full sm:w-2/3 lg:w-1/3">
          ...
          >
            <div class="relative team-image">
              <img class="w-full" src="/src/assets/images/team-1.png" alt="Team" />
        ...
        <div class="w-full sm:w-2/3 lg:w-1/3">
          ...
          >
            <div class="relative team-image">
              <img class="w-full" src="/src/assets/images/team-2.png" alt="Team" />
              <div class="team-social">
                <ul>
                  <li>
                    <a href="javascript:void(0)"><i class="lni lni-facebook-filled"></i></a>
        ...
        <div class="w-full sm:w-2/3 lg:w-1/3">
          ...
          >
            <div class="relative team-image">
              <img class="w-full" src="/src/assets/images/team-3.png" alt="Team" />
              <div class="team-social">
                <ul>
                  <li>
                    <a href="javascript:void(0)"><i class="lni lni-facebook-filled"></i></a>
